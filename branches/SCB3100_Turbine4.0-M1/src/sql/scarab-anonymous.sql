...
INSERT INTO TURBINE_USER (USER_ID, LOGIN_NAME, PASSWORD_VALUE, FIRST_NAME, LAST_NAME, EMAIL, CONFIRM_VALUE, MODIFIED, CREATED, LAST_LOGIN) 
    VALUES (9, '${scarab.anonymous.username}', 'NWoZK3kTsExUV00Ywo1G5jlUKKs=', 'Scarab', 'anonymous', 'anonymous@scarab.example.org', 'CONFIRMED', null, null, null );
...
insert into TURBINE_ROLE_PERMISSION (ROLE_ID, PERMISSION_ID)
       select  TURBINE_ROLE.ROLE_ID, TURBINE_PERMISSION.PERMISSION_ID
         ...
         where TURBINE_ROLE.ROLE_NAME = '${scarab.anonymous.rolename}'
...
WHERE TURBINE_USER.LOGIN_NAME = '${scarab.anonymous.username}' AND 
TURBINE_ROLE.ROLE_NAME in ('${scarab.anonymous.username}');